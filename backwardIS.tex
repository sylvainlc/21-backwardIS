...
\begin{table}
\caption{Mean squared error $\|X_0 - \mathbb{E}[X_0|Y_{1:n}]\|^2$ for the Poorman smoother (PMS) and the Backward IS smoother, for states $\{X_k\}_{k=0}^n$ and observations $\{X_k\}_{k=0}^n$ generated with stochastic RNNs of dimension 32 and 64, for various number $J$ of backward samples. We consider sequences of observations with $n=24$ and $n=100$.}
\label{table:RNN_exp}
\centering 
\begin{adjustbox}{\textwidth}
\scriptstyle
\begin{tabular}{cc|cc|cc}
RNN dim & backward samples & 24 obs - PMS & 24 obs - backward IS & 100 obs - PMS & 100 obs - backward IS  \\\toprule
\hline
d = 32 & J = 2 & 0.2601 & 0.2434 & 0.2196 & ? 
d = 32 & J = 4 & X & 0.2494 & X & 0.1877
d = 32 & J = 8 & X & 0.2541 & X & ? 
\hline
d = 64 & J = 2 & 0.1498 & 0.1473 & & 
d = 64 & J = 4 & X & & &
d = 64 & J = 8 & X & & &
\hline
\bottomrule
