...
\title{Backward importance sampling for online estimation of state space models}
\date{}


\author[$\dag\,\amalg$]{Alice Martin\footnote{This action benefited from the support of the Chair « New Gen RetAIl » led by l’X – École polytechnique and the Fondation de l’École polytechnique, sponsored by CARREFOUR}}
...
Among SMC methods, algorithms have been designed in the last decades to solve the smoothing problem, such as the Forward Filtering Backward Simulation algorithm \cite{douc2011sequential}  or two-filter based approaches \cite{briers2010smoothing, fearnhead2010sequential, nguyen2017two}. %but 
...
$$
\pE \left[\af{0:n}(X_{0:n})\middle | Y_{0:n}\right]\eqsp,
$$
