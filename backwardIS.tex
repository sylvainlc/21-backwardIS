...
>>>>>>> a31c6354c90a8d41748e840a1ccfa6a390e54d38
...
\item We show that the proposed approach outperforms the existing methods in terms of computational efficiency and should be considered even when the acceptance rejection procedure can be performed (section \ref{sec:simu:SINE}). 
