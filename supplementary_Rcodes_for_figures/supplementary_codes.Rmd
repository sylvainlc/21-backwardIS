...
Smoothing functions for the stochastic volatility model are available in the file `utils_SV_PF_functions.R`.
The user can change the `smoothing` argument in the code below to test other smoothing methods (such as `PoorMan` or `FFBSi`).
